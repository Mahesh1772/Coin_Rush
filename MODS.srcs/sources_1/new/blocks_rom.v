...
module blocks_rom(
	...
	always @*
	case ({row_reg, col_reg})
        4'b0000: color_data = 16'b0000010011100000;
        4'b0001: color_data = 16'b0000010010100000;
        4'b0010: color_data = 16'b0000010000100001;
        4'b0011: color_data = 16'b0000010001000001;
        4'b0100: color_data = 16'b0011101110000100;
        4'b0101: color_data = 16'b0100101110000101;
        4'b0110: color_data = 16'b0101101101000110;
        4'b0111: color_data = 16'b0101101101000110;
        4'b1000: color_data = 16'b1100010100001011;
        4'b1001: color_data = 16'b1100010100001100;
        4'b1010: color_data = 16'b1100010100101100;
        4'b1011: color_data = 16'b1100010101101011;
        4'b1100: color_data = 16'b1100110101101100;
        4'b1101: color_data = 16'b1100110101001100;
        4'b1110: color_data = 16'b1100110101101100;
        4'b1111: color_data = 16'b1100110101101100;
