module mario_sprite
    ...
    mario_rom mario_rom_unit (.clk(clk), .row(row), .col(col), .color_data(color_data_mario));
	
    // instantiate mario ghost ROM circuit
    mario_damaged_rom mario_damaged_rom_unit (.clk(clk), .row(row), .col(col), .color_data(color_data_mario_ghost));
